    ...
    <div class="container">
        <div class="site-navigation">
            ...
            <ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
                ...
                <li class="{{ Request::is('list-worker') ? 'active' : '' }}"><a href="{{ route('worker') }}">Pekerja</a>
                </li>
                    ...
                    <li class="has-children">
                        ...
                        <ul class="dropdown">
                            ...
                            @if (Auth::user()->role == 'Worker')
                                <li><a href="{{ route('myBid') }}"><i class="fa-solid fa-list-check"></i>Bid Saya</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                            @endif
                            <li>
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                    ...
                                    <span class="align-middle"><i class="fa-solid fa-right-from-bracket"></i>Keluar</span>
                                </a>
