            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.update', $user -> id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name"
                                placeholder=" Insert your Name" name="name" required value="{{ $user -> name }}" />
                        </div>
                    </div>
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="basic-default-name"
                                placeholder="Insert your Email" name="email" required value="{{ $user -> email }}" />
                        </div>
                    </div>
                    <div class="row mb-3 align-items-center">
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name"
                                placeholder=" Insert your phone" name="phone" required value="{{ $user -> phone }}" />
                        </div>
                    </div>
                    <div class="row mb-3 align-items-center">
                    ...
                    <div class="row">
                        ...
                        <img class="img-preview col-sm-5 mb-3" src="{{ asset('storage/'.$user -> photo) }}"
                            style="max-width: 200px;max-height: 200px">
                    </div>
                    <input type="hidden" value="{{ $user -> photo }}" name="oldImage">
                    <div class="row mb-3 align-items-center">
