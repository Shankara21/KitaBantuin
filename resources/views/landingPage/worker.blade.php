            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mx-auto text-center">
                        <div class="intro-wrap">
                            <h1 class="mb-0">Our Worker</h1>
                            <p class="text-white">Far far away, behind the word mountains, far from the countries
                                Vokalia and
                                Consonantia, there live the blind texts. </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-12  mb-4">
                        <div class="card shadow" style="border-radius: 20px;background:white">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/details-worker/{{ $item -> id }}"
                                    class="btn btn-secondary d-block">Details</a>
                            </div>
                        </div>
                    </div>
                    @empty
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-12  mb-4">
                            <div class="card shadow" style="border-radius: 20px;background:white">
                                ...
                                <div class="card-body">
                                    <h5>Muhammad lazuardi Timur</h5>
                                    <p class="text-muted mb-4">Fullstack Developer</p>
                                    <div class="mb-4">
                                        <div class="owl-single dots-absolute owl-carousel">
                                            <img src="/landingPage/images/slider-1.jpg"
                                                alt="Free HTML Template by Untree.co" class="img-fluid"
                                                style="border-radius: 25px">
                                            <img src="/landingPage/images/slider-2.jpg"
                                                alt="Free HTML Template by Untree.co" class="img-fluid"
                                                style="border-radius: 25px">
