        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 pl-lg-5 ml-auto">
                    <h2 class="section-title mb-4">About kITabantuin.co</h2>
    ...
    <div class="untree_co-section">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-5">
                    <h2 class="section-title text-left mb-4">Tentang Kita</h2>
                    <p>Yang melatarbelakangi berdirinya usaha ini adalah adanya fakta bahawa sebagian besar masyarakat
                        indonesia masih belum memiliki kemampuan dan pemahaman mengenai bidang IT. Bagi UMKM maupun pelaku
                        usaha yang ingin mengembangkan usahanya, sering kali mengalami permasalahan berupa sulitnya
                        pemasaran jika dilakukan secara konvensional, oleh sebab itu jasa ini sangat diperlukan untuk
                        membantu perkembangan usaha tersebut</p>
