            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mx-auto text-center">
                    <div class="intro-wrap">
                        ...
                        <p class="text-white">Anda Dapat menambahkan atau mengganti skill yang anda miliki</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    ...
                                    <form action="/edit-skill/{id}" method="POST" class="mb-5"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="js-example-basic-multiple select2-multiple form-control"
                                                name="skill[]" multiple="multiple">
                                                @foreach ($skills as $skill)
                                                    <option value="{{ $skill->name }}"
                                                        @if (in_array($skill->name, $check)) selected @endif>
                                                        {{ $skill->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
