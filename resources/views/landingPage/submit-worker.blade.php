                ...
                <div class="row mb-3">
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            <input required name="photo" class="form-control   @error('image') is-invalid
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            <input required name="ktp" class="form-control   @error('image') is-invalid
                                                                                    @enderror" type="file" id="ktp"
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            <input required name="cv" class="form-control   @error('image') is-invalid
                                                                                    @enderror" type="file" id="cv"
