                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="" {{ route('list-project') }}>
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <select class="custom-select" name="filter_category" id=""
                                                onchange="submit()">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" name="search" id="search"
                                                            class="form-control" placeholder="Search" onchange="submit()"
                                                            value="{{ request('search') }}">
                                                    </div>
                                                </div>
                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                <h6 class="text-bold pl-5">Anggaran :
                                                                                    <span
                                                                                        class="text-muted">{{ $item->budget }}</span>
                                                                                </h6>
                                                                            </div>
                                                                            <div class="col-6">
                                                                                <h6 class=" pl-5">Tenggat waktu :
                                                                                    <span
                                                                                        class="text-muted">{{ $item->deadline }}</span>
                                                                                </h6>
                                                                            </div>
                                                                            <div class="col-6">
                                                                            ...
                                                                            <div class="col-6">
                                                                                <h6 class=" pl-5">Status :
                                                                                    <span
                                                                                        class="text-muted">{{ $item->status }}</span>
                                                                                </h6>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title"
                                                                                        id="staticBackdropLabel">Bid Proyek
                                                                                    </h5>
